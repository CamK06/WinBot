...
namespace WinBot.Commands.Images
{
    public class HoohCommand : BaseCommandModule
    {
        ...
        public async Task Hooh(CommandContext Context, [RemainingText]string input)
        {
            ...
            string finalimgFile = TempManager.GetTempFile(seed+"-hooh." + args.extension, true);
            if(args.extension.ToLower() != "gif")
            ...
            TempManager.RemoveTempFile(seed+"-hooh."+args.extension);
        }

        void DoHooh(MagickImage image)
        {
            MagickImage top;
