...
namespace WinBot.Commands.Images
{
    public class WaawCommand : BaseCommandModule
    {
        ...
        public async Task Waaw(CommandContext Context, [RemainingText]string input)
        {
            ...
            string finalimgFile = TempManager.GetTempFile(seed+"-waaw." + args.extension, true);
            if(args.extension.ToLower() != "gif")
            ...
            TempManager.RemoveTempFile(seed+"-waaw."+args.extension);
        }

        void DoWaaw(MagickImage image)
        {
            MagickImage left;
