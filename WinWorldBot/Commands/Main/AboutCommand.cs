...
namespace WinWorldBot.Commands
{
    public class AboutCommand : ModuleBase<SocketCommandContext>
    {
        ...
        private async Task About()
        {
            ...
            Embed.AddField("Features", "This bot only has features that are needed. It's not bloated to hell and back with features nobody uses and crappy 'premium' subscriptions... it's a bot. None of that is even half necessary", true);
